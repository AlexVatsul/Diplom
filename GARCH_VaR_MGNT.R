...
ggplot(data_combined, aes(x = time, y = value)) +
  ...
  labs(title = "MGNT: Сравнение моделей волатильности (норм. распр)",
...
ggplot(data_combined, aes(x = time, y = value)) +
  ...
  labs(title = "MGNT: Сравнение моделей волатильности (t. распр)",
       x = "Дата", y = "σ", color = "Модель") +
  theme_minimal() +
  theme(legend.position = "bottom")
...
ggplot(data_combined, aes(x = time, y = value)) +
  ...
  labs(title = "MGNT: Реализованная волатильность и модели GARCH (норм. распр)",
       x = "Дата", y = "σ", color = "Модель") +
  theme_minimal() +
  theme(legend.position = "bottom")
...
ggplot(data_combined, aes(x = time, y = value)) +
  ...
  labs(title = "MGNT: Реализованная волатильность и модели GARCH (t. распр)",
       x = "Дата", y = "σ", color = "Модель") +
  theme_minimal() +
  theme(legend.position = "bottom")
